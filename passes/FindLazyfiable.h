...
struct FindLazyfiableAnalysis : public ModulePass {
	...
	const std::set<Function*>& getLazyFunctionStats() { return _lazyFunctionsStats; }
	const std::set<std::pair<Function*, int>>& getLazyPathsStats() { return _lazyPathsStats; }
	const std::map<std::pair<Function*, int>, int>& getLazyfiableCallSiteStats() { return  _lazyfiableCallSitesStats; }

	const std::set<std::pair<Function*, int>>& getLazyfiablePaths() { return _lazyfiablePaths; }
	const std::set<std::pair<CallInst*, int>>& getLazyfiableCallSites() { return _lazyfiableCallSites; }
